			...
			public function render( $args, $content = '' ) {
				...
				if ( is_array( $this->image_data ) ) {
					...
					if ( is_array( $image_array ) ) {
						...
						// $content vs $saved_content check is for dynamic data.
						$this->args['src'] = is_string( $this->image_data['url'] ) && ! empty( $this->image_data['url'] ) && $saved_content === $content ? $this->image_data['url'] : $this->args['src'];
